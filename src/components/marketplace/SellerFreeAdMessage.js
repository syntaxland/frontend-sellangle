...
function SellerFreeAdMessage() {
  ...
  const sellerReplyFreeAdMessageState = useSelector(
    (state) => state.sellerReplyFreeAdMessageState
  );
  const { loading, success, error } = sellerReplyFreeAdMessageState;
  ...
  const handleSubmitReply = (e) => {
    ...
    dispatch(sellerReplyFreeAdMessage(messageData));
  };
...
export default SellerFreeAdMessage;
