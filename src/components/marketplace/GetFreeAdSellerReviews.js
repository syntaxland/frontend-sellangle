...
function GetFreeAdSellerReviews({ adId }) {
  ...
  const getFreeAdSellerReviewsState = useSelector(
    (state) => state.getFreeAdSellerReviewsState
  );
  const { loading, error, sellerFreeAdReviews } = getFreeAdSellerReviewsState;
  console.log("sellerFreeAdReviews:", sellerFreeAdReviews);
  ...
  const currentItems = sellerFreeAdReviews?.slice(
    indexOfFirstItem,
    indexOfLastItem
  );
  ...
  useEffect(() => {
    ...
    dispatch(getFreeAdSellerReviews(reviewData));
  }, [dispatch, adId]);
          ...
          {loading ? (
            ...
            <>
              ...
              <Pagination
                ...
                totalItems={sellerFreeAdReviews?.length}
...
export default GetFreeAdSellerReviews;
