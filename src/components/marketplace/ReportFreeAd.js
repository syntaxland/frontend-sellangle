...
import { reportFreeAd } from "../../actions/marketplaceSellerActions";
...
function ReportFreeAd({ history, adId }) {
  ...
  const reportFreeAdState = useSelector((state) => state.reportFreeAdState);
  const { loading, success, error } = reportFreeAdState;
  ...
  const submitHandler = (e) => {
    ...
    dispatch(reportFreeAd(adReportData));
  };
